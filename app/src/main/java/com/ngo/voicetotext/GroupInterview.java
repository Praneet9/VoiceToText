...
public class GroupInterview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_interview);
    ...
    public void setDetailsClicked(View v){
    ...
    public void nextButtonClicked(View v){
        ...
        intent.putExtra("filename","Group");
